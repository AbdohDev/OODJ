 ...
 * @author US
 */
public class OrderVaccine extends javax.swing.JFrame {

    /**
     * Creates new form OrderVaccine
     */
    public OrderVaccine() {
        initComponents();
    }
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(cmdBranch, 0, 176, Short.MAX_VALUE)
                                    .addComponent(txtQuantity)
                                    .addComponent(txtOrderID)
                                    .addComponent(cmdProductBrand, 0, 176, Short.MAX_VALUE))))))
                .addContainerGap())
        );
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ManageVaccine m =new ManageVaccine();
        if(m.ManageAddVaccine(OrderID, ProductBrand, Branch, Quantity))
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OrderVaccine.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OrderVaccine().setVisible(true);
            }
        });
    }
